...
public  static void createExeclFile(){
		...
		////// //创建第4行 
		     ...
		     // cell0.set
		      cell4=row0.createCell(1);
		      cell4.setCellValue("CASE KEY");
		      cell4.setCellStyle(headstyleCenter); 
		      //2
		      cell4=row0.createCell(2);
		      cell4.setCellValue("CUSTOMER KEY");
		      cell4.setCellStyle(headstyleCenter); 
		      //3
		      cell4=row0.createCell(3);
