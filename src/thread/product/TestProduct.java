...
public class TestProduct {
	...
	public static void main(String[] args) {
		...
		//启动生产者和消费者线程
		producers1.start();
		System.out.println("producers1.start()==="+new Date(System.currentTimeMillis()));
		producers2.start();
		System.out.println("producers2.start()==="+new Date(System.currentTimeMillis()));
		consumers1.start();
		System.out.println("consumers1.start()==="+new Date(System.currentTimeMillis()));
		producers3.start();
		System.out.println("producers3.start()==="+new Date(System.currentTimeMillis()));
		consumers2.start();
		System.out.println("consumers2.start()==="+new Date(System.currentTimeMillis()));
		consumers3.start();
		System.out.println("consumers3.start()==="+new Date(System.currentTimeMillis()));
		consumers4.start();
		//让生产者消费者程序运行1600ms
		try {
			Thread.sleep(1600);
